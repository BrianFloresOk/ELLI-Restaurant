...
export class InitMigration1761344234971 implements MigrationInterface {
    name = 'InitMigration1761344234971'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tables" ("id" SERIAL NOT NULL, "capacity" integer NOT NULL, "status" character varying NOT NULL DEFAULT 'AVAILABLE', "assignedWaiterId" integer, CONSTRAINT "PK_7cf2aca7af9550742f855d4eb69" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "payments" ("id" SERIAL NOT NULL, "orderId" integer NOT NULL, "method" character varying(50) NOT NULL, "amount" numeric(10,2) NOT NULL, "paidAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_af929a5f2a400fdb6913b4967e" UNIQUE ("orderId"), CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "tableId" integer NOT NULL, "waiterId" integer NOT NULL, "cashierId" integer, "status" character varying(50) NOT NULL, "orderDate" TIMESTAMP NOT NULL, "closedDate" TIMESTAMP, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" character varying(255), "price" numeric(10,2) NOT NULL, "stock" integer, "categoryId" integer NOT NULL, "type" character varying NOT NULL, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "order_items" ("id" SERIAL NOT NULL, "orderId" integer NOT NULL, "productId" integer NOT NULL, "quantity" integer NOT NULL, "unitPrice" numeric(10,2) NOT NULL, "status" character varying NOT NULL DEFAULT 'pending', "notes" character varying, CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_1073eb310020ca81d70fc8578a4" FOREIGN KEY ("cashierId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
